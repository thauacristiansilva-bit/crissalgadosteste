    ...
    <section className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      <div className="border-b border-gray-100 px-5 py-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div><div className="flex items-center gap-1.5"><h2 className="text-lg font-black">Inventário</h2><HelpTip helpKey="inventory.ingredients" /></div><p className="text-sm text-gray-500">Controle de produtos prontos e ingredientes da ficha técnica.</p></div>
