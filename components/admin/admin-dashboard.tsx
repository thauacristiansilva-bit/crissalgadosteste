...
const navItems: NavItem[] = [
  ...
  { key: "pdv", label: "Nova venda", icon: ShoppingCart, group: "vendas" },
  { key: "kitchen", label: "Cozinha", icon: ChefHat, group: "vendas" },
  { key: "sales", label: "Caixa", icon: WalletCards, group: "vendas" },
  { key: "dre", label: "Lucro e despesas", icon: DollarSign, group: "vendas" },
  { key: "products", label: "Produtos e sabores", icon: BookOpen, group: "catalogo" },
