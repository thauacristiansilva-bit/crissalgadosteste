...
export function PrinterSetup({ selectedAgentId, selectedPrinterName, onSelected }: {
  ...
  return <div className="mt-4 space-y-3 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-950">
    <strong className="block">Conectar impressora USB, Wi‑Fi ou Bluetooth</strong>
    <p>1. No computador do caixa, instale a impressora no Windows. Para Bluetooth, ligue a impressora e pareie em Impressoras e scanners &gt; Adicionar dispositivo. 2. Clique em Conectar impressora e abra o arquivo baixado nesse computador. 3. Escolha a impressora que aparecer abaixo.</p>
    <a href="ms-settings:printers" className="inline-block rounded-xl border border-blue-300 bg-white px-3 py-2 font-bold text-blue-800">Abrir impressoras do Windows</a>
