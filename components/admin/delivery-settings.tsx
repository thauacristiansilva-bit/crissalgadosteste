...
export function DeliverySettings({
  ...
  return <div className="space-y-5">
    ...
    <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center gap-3"><div className="rounded-xl bg-emerald-50 p-2.5 text-emerald-700"><Bike className="h-5 w-5" /></div><div><h2 className="text-lg font-bold text-gray-900">Entregadores</h2><p className="text-sm text-gray-500">Cadastre a equipe para atribuir pedidos de delivery.</p></div></div>
