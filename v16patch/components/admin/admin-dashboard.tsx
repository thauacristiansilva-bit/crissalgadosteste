  ...
  const nav = (
    <>
      <div className="border-b px-4 py-5" style={{ borderColor: "rgba(255,255,255,.10)" }}>
        <div className="rounded-3xl border p-4" style={{ borderColor: "rgba(255,255,255,.10)", background: "linear-gradient(135deg, rgba(255,255,255,.10), rgba(255,255,255,.03))" }}>
          <div className="flex items-center gap-3">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white p-1 shadow-md">
              <img src="/saborflow-brand.png" alt="SaborFlow" className="h-full w-full object-contain" />
            </div>
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-[0.24em]" style={{ color: "#ffd39f" }}>Plataforma SaborFlow</p>
              <p className="truncate text-2xl font-black text-white">SaborFlow™</p>
              <p className="truncate text-[11px]" style={{ color: "#ffe5c5" }}>Painel de gestão</p>
            </div>
          </div>
      ...
      <div className="border-t p-4" style={{ borderColor: "rgba(255,255,255,.10)" }}>
        ...
        <div className="mt-4 rounded-2xl border px-3 py-3 text-center" style={{ borderColor: "rgba(255,255,255,.08)", backgroundColor: "rgba(255,255,255,.04)" }}>
          <p className="text-[10px] font-black uppercase tracking-[0.2em]" style={{ color: "#ffd39f" }}>Plataforma SaborFlow</p>
          <p className="mt-1 text-xs font-bold text-white">SaborFlow™ · v1.0</p>
        </div>
      </div>
    </>
  )
    ...
    <div className="min-h-screen text-gray-950 lg:flex" style={{ backgroundColor: saborFlowBrand.cream }}>
      ...
      <div className="min-w-0 flex-1">
        <header className="sticky top-0 z-30 flex min-h-20 items-center justify-between border-b bg-white/95 px-4 py-3 backdrop-blur sm:px-6" style={{ borderColor: saborFlowBrand.border }}>
          <div className="flex items-center gap-3"><button onClick={() => setMobileNav(true)} type="button" className="rounded-2xl border p-2 text-gray-600 lg:hidden" style={{ borderColor: saborFlowBrand.border }} aria-label="Abrir menu"><Menu className="h-5 w-5" /></button><div className="flex items-center gap-3"><div className="hidden items-center gap-2 rounded-2xl border bg-white px-3 py-2 md:flex" style={{ borderColor: saborFlowBrand.border }}><img src="/saborflow-brand.png" alt="SaborFlow" className="h-10 w-10 rounded-xl object-contain" /><div><p className="text-[9px] font-black uppercase tracking-[0.2em]" style={{ color: saborFlowBrand.orangeStrong }}>Plataforma</p><p className="text-sm font-black" style={{ color: saborFlowBrand.brown }}>SaborFlow™</p></div></div><div><h1 className="font-black text-gray-950">{title}</h1><p className="hidden text-xs text-gray-500 sm:block">{settings.storeName} · {settings.city} - {settings.state}</p></div></div></div>
        ...
        <main className="mx-auto max-w-[1600px] p-4 sm:p-6">
          <div className="mb-5 flex flex-col gap-3 rounded-3xl border bg-white p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between" style={{ borderColor: saborFlowBrand.border }}>
            <div className="flex items-center gap-3"><img src="/saborflow-brand.png" alt="SaborFlow" className="h-12 w-12 rounded-2xl object-contain" /><div><p className="text-[10px] font-black uppercase tracking-[0.22em]" style={{ color: saborFlowBrand.orangeStrong }}>SaborFlow™</p><p className="text-sm font-bold" style={{ color: saborFlowBrand.brown }}>Empresa ativa · {settings.storeName}</p></div></div>
          ...
          <footer className="mt-8 rounded-3xl border bg-white px-5 py-4 shadow-sm" style={{ borderColor: saborFlowBrand.border }}>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3"><img src="/saborflow-brand.png" alt="SaborFlow" className="h-10 w-10 rounded-xl object-contain" /><div><p className="text-sm font-black" style={{ color: saborFlowBrand.brown }}>SaborFlow™</p><p className="text-xs text-gray-500">Painel administrativo da Plataforma SaborFlow.</p></div></div>
