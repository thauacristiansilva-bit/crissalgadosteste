...
async function main() {
  ...
  try {
    ...
    for (const row of result.rows) {
      ...
      console.log(
        `Produto: ${row.product_name} (id ${row.product_id})`
      )
      console.log(
        `Preco normal: ${Number(row.normal_price).toFixed(2)}`
      )
      console.log(
        `Preco promocional: ${Number(row.promotional_price).toFixed(2)}`
      )
      console.log(
        `Ativa no admin: ${row.active}`
      )
      console.log(
      ...
      console.log(
        `Agora na loja: ${now.date} ${now.time} | dia ${now.day}`
      )
      console.log(
        `Data inicial: ${startDate || "sem limite"}`
      )
      console.log(
        `Data final: ${endDate || "sem limite"}`
      )
      console.log(
        `Dias permitidos: [${days.join(", ")}]`
      )
      console.log(
        `Horario: ${startTime} ate ${endTime}`
      )
      console.log("")
