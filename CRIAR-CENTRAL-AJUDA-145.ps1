...
Write-Host ""
Write-Host "=== ETAPA 14.5 - CENTRAL DE AJUDA / BASE DE CONHECIMENTO ==="
Write-Host ""
...
$target = "database\migrations\036_help_center.sql"
...
Write-Host ""
Write-Host "ETAPA 14.5 - MIGRATION CENTRAL DE AJUDA CRIADA"
Write-Host ""
